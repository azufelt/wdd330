...
context.fillStyle = "#005f73"; // a blue fill color 
...
context.fillStyle = '#8fbec5'; // a blue fill color
context.font = 'bold 26px sans-serif';
context.fillText('Hello', 20, 200);


//canvas can also be used to draw data charts that are updated in real-time based on delivered data. 